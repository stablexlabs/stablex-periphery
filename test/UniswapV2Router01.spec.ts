...
enum RouterVersion {
  StableXRouter01 = 'StableXRouter01',
  StableXRouter02 = 'StableXRouter02'
}

describe('StableXRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.StableXRouter01]: fixture.router01,
        [RouterVersion.StableXRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.StableXRouter01]: 101876,
              [RouterVersion.StableXRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.StableXRouter01]: 138770,
              [RouterVersion.StableXRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
